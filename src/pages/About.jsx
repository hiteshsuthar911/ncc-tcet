...
export default function About() {
  return (
    <div className="min-h-screen pt-20">
      {/* ── HERO ── */}
      <section className="relative py-24 bg-military-darker overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-army-300 font-body text-lg leading-relaxed">
        ...
        {/* Decorative */}
        <div className="absolute bottom-0 right-10 w-32 h-32 border border-gold-500/10" />
        <div className="absolute top-10 right-32 w-16 h-16 border border-army-600/30" />
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="card-army p-8 relative">
              ...
              <h3 className="font-heading text-2xl text-white uppercase tracking-widest mb-4">
                Our Mission
              </h3>
              <p className="text-army-300 font-body leading-relaxed">
            ...
            <div className="card-army p-8 relative">
              ...
              <p className="text-army-300 font-body leading-relaxed">
                To be recognized as the best NCC Unit in Maharashtra, producing cadets who exemplify the NCC motto — <em className="text-gold-400">"Unity and Discipline"</em> — and go on to serve the nation in military and civilian capacities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 bg-army-900 border-y border-army-700">
        <div className="max-w-4xl mx-auto text-center px-4">
          <p className="font-heading text-xl md:text-2xl text-army-400 tracking-[0.2em] uppercase mb-2">
            NCC Motto
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="divider-gold w-24 mb-6" />
              <p className="text-army-300 font-body leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {ACTIVITIES.map((activity) => (
                  <div key={activity} className="flex items-center gap-2">
                    ...
                    <span className="text-army-300 text-sm font-body">{activity}</span>
                  </div>
                ))}
              </div>
            </div>
            <div className="relative">
              <div className="card-army p-8 text-center">
                ...
                <p className="text-army-300 font-body leading-relaxed mb-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={label} className="text-center">
                      <p className="font-heading text-2xl text-gold-400">{value}</p>
                      <p className="text-army-500 text-xs font-body">{label}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="py-20 bg-military-darker">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-army-700 md:-translate-x-px" />
            <div className="space-y-10">
              {TIMELINE.map((item, i) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-6 md:left-1/2 w-3 h-3 bg-gold-500 rounded-full -translate-x-1.5 md:-translate-x-1.5 border-2 border-military-darker mt-1" />
                  {/* Content */}
                  <div className={`ml-14 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                    <div className="card-army p-5">
                      ...
                      <h3 className="font-heading text-white uppercase tracking-wide text-lg mb-1">
                        {item.title}
                      </h3>
                      <p className="text-army-400 text-sm font-body">{item.desc}</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {OFFICERS.map(({ rank, name, role }) => (
              <div key={role} className="card-army p-6 text-center group hover:bg-army-900 transition-all duration-300">
                <div className="w-20 h-20 bg-army-800 border-2 border-army-600 group-hover:border-gold-500 transition-colors duration-300 flex items-center justify-center rounded-full mx-auto mb-4">
                  <Users className="w-8 h-8 text-army-400 group-hover:text-gold-400 transition-colors duration-300" />
                </div>
                <span className="badge-rank mb-2 inline-flex">{rank}</span>
                <h4 className="font-heading text-white text-sm uppercase tracking-wider mt-2">{name}</h4>
                <p className="text-army-500 text-xs font-body mt-1">{role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA ── */}
      <section className="py-16 bg-military-darker border-t border-army-800">
        <div className="max-w-3xl mx-auto text-center px-4">
          <Award className="w-12 h-12 text-gold-500 mx-auto mb-4" />
          <h2 className="section-title text-3xl mb-4">Be Part of the Unit</h2>
          <p className="text-army-300 font-body mb-8">
